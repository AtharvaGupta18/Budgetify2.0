            ...
            <SafeAreaView style={styles.container}>
                ...
                <View style={styles.header}>
                    <View>
                        ...
                        <Text style={styles.subWelcomeText}>Good to see you again!</Text>
                    </View>
                </View>
                    ...
                    <View style={styles.transactionList}>
                        ...
                        <View style={styles.transactionItem}>
                            ...
                            <View style={styles.transDetails}>
                                <Text style={styles.transTitle}>Salary</Text>
                                <Text style={styles.transDate}>Today</Text>
                            </View>
                            <Text style={[styles.transAmount, { color: '#2BB673' }]}>+ ₹ 40,000</Text>
                        </View>
                        ...
                        <View style={styles.transactionItem}>
                            ...
                            <View style={styles.transDetails}>
                                <Text style={styles.transTitle}>Groceries</Text>
                                <Text style={styles.transDate}>Today</Text>
                            </View>
                            <Text style={[styles.transAmount, { color: '#333' }]}>- ₹ 1,250</Text>
                        </View>
                        ...
                        <View style={styles.transactionItem}>
                            ...
                            <View style={styles.transDetails}>
                                <Text style={styles.transTitle}>Food</Text>
                                <Text style={styles.transDate}>Yesterday</Text>
                            </View>
                            <Text style={[styles.transAmount, { color: '#333' }]}>- ₹ 350</Text>
                        </View>
                        ...
                        <View style={styles.transactionItem}>
                            ...
                            <View style={styles.transDetails}>
                                <Text style={styles.transTitle}>Transport</Text>
                                <Text style={styles.transDate}>Yesterday</Text>
                            </View>
                            <Text style={[styles.transAmount, { color: '#333' }]}>- ₹ 120</Text>
                        </View>
                    </View>
